...
<body>
    ...
    <a href="${pageContext.request.contextPath}/reservation/">R&eacute;server un Livre</a>
    <a href="${pageContext.request.contextPath}/reservation/resa-attente">R&eacute;servations en attente</a>
